...
CREATE TABLE IF NOT EXISTS `banking_system`.`transactions` (
  ...
  `status` ENUM('pending', 'completed', 'failed', 'reversal') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banking_system`.`transaction_account` (
  ...
  INDEX `fk_transaction_account_accounts1_idx` (`from_account_id` ASC) VISIBLE,
  INDEX `fk_transaction_account_accounts1_idx1` (`to_account_id` ASC) VISIBLE,
